...
namespace UnitTest
{
    ...
    public class UnitTest1
    {
        ...
        public void Can_Paginate()
        {
            ...
            BooksController contoller = new BooksController(mock.Object);
            contoller.pageSize = 3;
            IEnumerable<Book> result = (IEnumerable<Book>)contoller.List(null,2).Model;
        ...
        [TestMethod]
        public void Can_Genrerate_Page_Links()
        {
        ...
        [TestMethod]
        public void Can_Pangination_View_model()
        {
            ...
            Assert.AreEqual(pagingInfo.TotlaPage, 2);
        }
        [TestMethod]
        public void Can_Filter_Books()
        {
            ...
            Assert.IsTrue(result[1].Name == "Book2" && result[1].Genre == "Genre2");
